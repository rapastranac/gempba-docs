...
Implements [`scheduler`](../../interfaces/scheduler.md). The recommended multiprocessing scheduler. Uses MPI as the IPC transport (OpenMPI on Linux/macOS, MS-MPI on Windows).
